...
1. Укажите короткий код, название и страну.

1. В base_url внесите полный адрес с портом, например http://203.0.113.10:51351.

1. Вставьте NODE_AGENT_TOKEN.

1. Для ноды на главном сервере включите is_local.

1. Сохраните и нажмите «Проверить».
