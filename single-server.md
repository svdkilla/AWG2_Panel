...
1. Убедитесь, что контейнер amnezia-awg2 запущен.

1. Скопируйте сборку панели в /opt/xconnect-awg-panel.
...
1. Сохраняет устройство и peer в SQLite.

1. Пересобирает awg0.conf.

1. Применяет изменения через awg syncconf.
